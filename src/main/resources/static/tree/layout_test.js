...
if (config.test) {
    ...
    // Children: 6
    model.fakeNewFamily();
    model.fakeAttachParent(3, 5);
    model.fakeAttachChild(3, 6);
    // Parents: 4 6
    // Children 7
    model.fakeNewFamily();
    model.fakeAttachParent(4, 4);
    model.fakeAttachParent(4, 6);
...
if (config.test) {
    ...
    model.fakeNewFamily();
    model.fakeAttachParent(3, 7);
    model.fakeAttachParent(3, 8);
    model.fakeAttachChild(3, 9);
    model.fakeAttachChild(3, 15);
    // Parents: 10 11
    // Children: 12 16
    model.fakeNewFamily();
    model.fakeAttachParent(4, 10);
    model.fakeAttachParent(4, 11);
    model.fakeAttachChild(4, 12);
    model.fakeAttachChild(3, 16);
    // Parents: 13 6
    model.fakeNewFamily();
    model.fakeAttachParent(5, 13);
    model.fakeAttachParent(5, 6);
    // Parents: 15 12
    model.fakeNewFamily();
    model.fakeAttachParent(6, 15);
    model.fakeAttachParent(6, 12);
    // Parents: 14 16
    model.fakeNewFamily();
    model.fakeAttachParent(7, 14);
    model.fakeAttachParent(7, 16);
    layout.recalculateLayerAssignment();
    // This output might be useful when debugging this test.
    // console.log("layers:");
    // console.log(layout.layers);
...
if (config.test) {
    console.log("layout_test.ts: Starting [weird stuff]");
    model.reset();
    for (let i = 1; i <= 2; i += 1) {
        model.fakeNewPerson("name" + i);
    }
    ...
    console.log("layout_test.ts: Finished [weird stuff]");
    // model.reset();
}
